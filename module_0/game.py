...
def game_core(number):
    '''Сначала устанавливаем устанавливаем 2 прогнозируемого числа, минимальное и максимальное, находим среднее их значение, а потом уменьшаем или увеличиваем их в зависимости от того, больше их среднее значеник или меньше нужного.
